...
<div class="panel-body">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo '$'.$item["price"].' PC'; ?></td>
            <td><input type="number" class="form-control text-center" value="<?php echo $item["qty"]; ?>" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>')"></td>
            <td><?php echo '$'.$item["subtotal"].' PC'; ?></td>
            <td>
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-center"><strong>Total <?php echo '$'.$cart->total().'PC'; ?></strong></td>
 ...
 <div class="panel-footer">Innobar</div>
 </div><!--Panek cierra-->
