...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
    ...
    <div class="form-group">
        <textarea class="form-control" rows="3" name="address" id="address" placeholder="Numero del documento"></textarea>
    </div>
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
    <span class="form-inline">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input value="" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Impuestos">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-addon currency">$</div>
                <input value="" type="number" class="form-control" name="amountPaid" id="amountPaid" placeholder="Monto Recibido">
            </div>
        </div>
        <div class="form-group">
            <label>Vueltas: &nbsp;</label>
            <div class="input-group">
                <div class="input-group-addon currency">$</div>
                <input value="" type="number" class="form-control" name="amountDue" id="amountDue" placeholder="Vueltas">
            </div>
        </div>
    </span>
</div>
