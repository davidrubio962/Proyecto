	    	...
	    	<div class="load-animate animated fadeInUp">
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
						...
						<div class="form-group">
							<textarea class="form-control" rows="3" name="address" id="address" placeholder="Numero de Indentificación"><?php echo $invoiceValues['order_receiver_address']; ?></textarea>
						</div>
...
<?php } ?>		
		      	...
		      	<div class="row">	
		      		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
		      			<h3>Notes: </h3>
		      			<div class="form-group">
							<textarea class="form-control txt" rows="5" name="notes" id="notes" placeholder="Apreciaciones"><?php echo $invoiceValues['note']; ?></textarea>
						</div>
						<br>
						<div class="form-group">
							<input type="hidden" value="<?php echo $_SESSION['userid']; ?>" class="form-control" name="userId">
							<input type="hidden" value="<?php echo $invoiceValues['order_id']; ?>" class="form-control" name="invoiceId" id="invoiceId">
			      			<input data-loading-text="Updating Invoice..." type="submit" name="invoice_btn" value="Actualziar" class="btn btn-success submit_btn invoice-save-btm">
			      		</div>
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<span class="form-inline">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input value="<?php echo $invoiceValues['order_tax_per']; ?>" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Impuestos">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo $invoiceValues['order_total_tax']; ?>" type="number" class="form-control" name="taxAmount" id="taxAmount" placeholder="IVA">
								</div>
							</div>							
							<div class="form-group">
								<label>Total: &nbsp;</label>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo $invoiceValues['order_amount_paid']; ?>" type="number" class="form-control" name="amountPaid" id="amountPaid" placeholder="Monto Recibido">
								</div>
							</div>
							<div class="form-group">
								<label>Vueltas: &nbsp;</label>
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo $invoiceValues['order_total_amount_due']; ?>" type="number" class="form-control" name="amountDue" id="amountDue" placeholder="Vueltas">
								</div>
							</div>
						</span>
					</div>
